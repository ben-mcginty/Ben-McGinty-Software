...
while loopcount <= loopnumber:
    ...
    #printing door locations to console
...
while loopcount <= loopnumber:
    ...
    #printing door locations
    print("The original door chosen is door ", chosen_door)
    print("The switched door is door ",switched_door)
    print("The prize door is door ", prize_door)
